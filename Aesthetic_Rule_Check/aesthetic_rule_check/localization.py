...
METRIC_LABELS: dict[tuple[str, str], str] = {
    ("geometry", "whitespace"): "DSL留白",
    ("geometry", "density"): "DSL信息密度",
    ("geometry", "padding"): "DSL安全边距",
    ("geometry", "alignment"): "DSL对齐",
    ("geometry", "grid"): "DSL隐式网格",
    ("geometry", "overlap"): "DSL重叠",
    ("geometry", "spacing_rhythm"): "DSL间距节奏",
    ("geometry", "typography_hierarchy"): "DSL字号层级",
...
METRIC_DESCRIPTIONS: dict[tuple[str, str], str] = {
    ("geometry", "whitespace"): "DSL 留白基于可见组件 bbox 的并集面积计算，用于判断设计几何是否过空或过挤。",
    ("geometry", "density"): "DSL 信息密度基于可见组件 bbox 的并集面积计算，避免重叠组件重复计面积。",
    ("geometry", "padding"): "DSL 安全边距衡量主要组件与卡片边缘的距离，以及四边边距是否稳定。",
    ("geometry", "alignment"): "DSL 对齐衡量组件左边缘和中心线是否形成稳定秩序。",
    ("geometry", "grid"): "DSL 隐式网格会自动尝试 4/8/12/16vp，判断元素是否吸附到稳定节奏。",
    ("geometry", "overlap"): "DSL 重叠基于组件 bbox IoU，容器包含子元素不视为重叠问题。",
    ("geometry", "spacing_rhythm"): "DSL 间距节奏衡量组件之间垂直 gap 是否稳定。",
    ("geometry", "typography_hierarchy"): "DSL 字号层级直接读取 styles.fontSize，判断标题、核心数值和辅助信息的层级是否清晰。",
